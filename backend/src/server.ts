...
import couponRecordRoutes from './routes/couponRecordRoutes';
import wishlistRecordRoutes from './routes/wishlistRecordRoutes';
import eventRecordRoutes from './routes/eventRecordRoutes';
import placeRecordRoutes from './routes/placeRecordRoutes';
...
app.use('/api/coupons-v2', couponRecordRoutes);
app.use('/api/wishlist-v2', wishlistRecordRoutes);
app.use('/api/events-v2', eventRecordRoutes);
app.use('/api/places-v2', placeRecordRoutes);
